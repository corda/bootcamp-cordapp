...
public class IssueCommandContractTests {
    ...
    @Test
    public void issueCommandRequiresZeroInputsInTheTransaction() {
    ...
    @Test
    public void issueCommandRequiresOneOutputInTheTransaction() {
        transaction(ledgerServices, tx -> {
    ...
    @Test
    public void issueCommandRequiresOneCommandInTheTransaction() {
        transaction(ledgerServices, tx -> {
            tx.output(TokenContract.ID, tokenState);
    ...
    @Test
    public void issueCommandRequiresTheTransactionsOutputToBeATokenState() {
        transaction(ledgerServices, tx -> {
    ...
    @Test
    public void issueCommandRequiresTheTransactionsOutputToHaveAPositiveAmount() {
    ...
    @Test
    public void issueCommandRequiresTheTransactionsCommandToBeAnIssueCommand() {
        transaction(ledgerServices, tx -> {
    ...
    @Test
    public void issueCommandRequiresTheIssuerToBeARequiredSignerInTheTransaction() {
